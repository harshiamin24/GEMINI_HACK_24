...
import { Bike, Shield, ArrowRight, Building, User, Mail, Lock } from 'lucide-react';

export default function Register() {
  const [fullName, setFullName] = useState('');
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');
  const [orgName, setOrgName] = useState('Metro Green Logistics Co.');
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <h2 className="text-3xl font-extrabold text-white tracking-tight">Register UrbanLogix</h2>
        <p className="mt-2 text-sm text-slate-400">
          Set up your organization for zero-emission micro-hub dispatch
        </p>
      </div>
        ...
        <div className="bg-slate-900/90 backdrop-blur-xl py-8 px-6 sm:px-10 shadow-2xl rounded-3xl border border-slate-800">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Metro Green Logistics Co."
                  className="w-full bg-slate-950 border border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="elena@metrogreen.eco"
                  className="w-full bg-slate-950 border border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              >
                <option value="dispatcher">Dispatcher (Route Optimization & Hub Allocation)</option>
                <option value="admin">Admin (Fleet Configuration & Organization Rules)</option>
                <option value="rider">Rider (Courier Turn-by-Turn Route Execution)</option>
              </select>
            </div>
